 ...
 * @author Masoume
 */
public class QueueLearningDone extends InputEvent {
    ...
    public QueueLearningDone() {
        id = UUID.randomUUID();
    }
    
    public QueueLearningDone(UUID relevantOutputEventUuid, UUID missionUuid,ArrayList<BoatProxy> boatProxyList) {
