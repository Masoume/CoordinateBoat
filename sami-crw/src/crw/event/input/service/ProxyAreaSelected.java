 ...
 */
public class ProxyAreaSelected extends InputEvent {
    ...
    public ProxyAreaSelected() {
    }

    public ProxyAreaSelected(UUID relevantOutputEventUuid, UUID missionUuid, Hashtable<ProxyInt, Path> computedPaths, ArrayList<ProxyInt> relevantProxyList) {
