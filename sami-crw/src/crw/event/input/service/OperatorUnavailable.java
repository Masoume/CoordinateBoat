 ...
 * @author Masoume
 */
public class OperatorUnavailable extends InputEvent{
    ...
    public OperatorUnavailable() {   
        id = UUID.randomUUID();
    }

    public OperatorUnavailable(UUID relevantOutputEventUuid, UUID missionUuid, ArrayList<BoatProxy> boatProxyList) {
   //public OperatorUnavailable(UUID relevantOutputEventUuid, UUID missionUuid) {
