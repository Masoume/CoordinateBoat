...
public class InterruptPanel extends javax.swing.JPanel implements PlanManagerListenerInt, ProxyServerListenerInt {
    ...
    ArrayList<ProxyInt> previous = new ArrayList<ProxyInt>();
    ...
    private void genericIntBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_genericIntBActionPerformed
        ...
        System.out.println("Count of listeners: " + ((JButton) evt.getSource()).getActionListeners().length);
                System.out.println("T: "+evt.getActionCommand()+" R:"+evt.getSource()+" M:"+evt.INVOCATION_EVENT_MASK+" L:"+evt.getWhen()+" "+evt.paramString()+" "+evt.getModifiers()+evt.ACTION_FIRST+evt.ACTION_LAST);
//((JButton) evt.getSource()).g
        if (pmSelected != null) {
...
//            Arrays.sort(boatsSelected);
//            Arrays.sort(previous);
//            if (!boatsSelected.equals(previous)) {
