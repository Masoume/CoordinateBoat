...
import crw.event.input.operator.OperatorSelectsAssignmentMethod;
...
import crw.uilanguage.message.fromui.AreaSelectedMessage;
...
import crw.uilanguage.message.fromui.MethodOptionSelectedMessage;
...
public class CrwUiServerListener implements UiServerListenerInt, InformationServiceProviderInt {
    ...
    public void FromUiMessage(FromUiMessage m) {
        ...
        } else if (m instanceof MethodOptionSelectedMessage) {
            
            generatorEvent = new OperatorSelectsAssignmentMethod(m.getRelevantOutputEventId(), m.getMissionId(), ((MethodOptionSelectedMessage)m).getMethod());
...
//        } else if (m instanceof AreaSelectedMessage){
//            generatorEvent = new OperatorSelectsDangerousArea(m.getRelevantOutputEventId(),m.getMissionId(),((AreaSelectedMessage) m).getArea()); 
//           //generatorEvent = new OperatorSelectsDangerousArea(m.getRelevantOutputEventId(),m.getMissionId(),((AreaSelectedMessage) m).getPositions());
        }else {
    ...
    public boolean offer(GeneratedInputEventSubscription sub) {
        ...
        if (sub.getSubscriptionClass().equals(OperatorAcceptsAllocation.class)
                ...
                || sub.getSubscriptionClass().equals(OperatorSelectsDangerousArea.class)
                || sub.getSubscriptionClass().equals(OperatorSelectsAssignmentMethod.class)
