...
//        System.out.println("Cost based");
        ...
        do {
          ...
          //  System.out.println("dummyPos "+dummyPos.size());
            Position test = dummyPos.get(0);
//        System.out.println("TEST POS: "+test);
            for (BoatMarker b : boats) {
                ...
                HashMap<Double, ArrayList<Position>> allPathsCost = computeBestPath(b, tmp);
//                } else if (working) {
//                    allPathsCost = computeNewInsertPath(b, tmp);
//                } else {
//                    allPathsCost = computeBestPath(b, tmp);
//                }
//        System.out.println("ALLPATH: "+allPathsCost);
